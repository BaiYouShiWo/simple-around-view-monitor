...
parser.add_argument('-path', '--INPUT_PATH', default='./data/image/front', type=str, help='Input Source/Destination Image Path')
...
parser.add_argument('-size','--SCALED_SIZE', default=20, type=int, help='Scaled Chess Board Square Size (image pixel)')
...
def main():
    ...
    for i in range(len(srcfiles)):    
        ...
        np.save('./data/{}/camera_{}_H.npy'.format(args.CAMERA_ID,args.CAMERA_ID), homography)
